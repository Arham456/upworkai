...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-6 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto gap-8">
        ...
        >
          ...
          <br />
          <span className="text-green-400">Proposals with AI</span>
        </motion.h1>
        ...
        >
          Stop getting ignored. Start winning clients.
        </motion.p>
